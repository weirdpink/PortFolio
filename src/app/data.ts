...
export const projects: Project[] = [
  ...
  },
  {
    id: "p-pulse",
    title: "Pulse",
    description: "A predictive market terminal for researching stocks and crypto with price forecasts, technical indicators, and consensus trading signals.",
    category: "Website",
    discipline: "Engineering",
    tools: ["Python", "Flask", "Scikit-learn", "yfinance"],
    gallery: [],
    link: "https://github.com/weirdpink/Pulse",
    caseStudy: "/project/p-pulse",
    year: "2026",
    role: "Full-Stack Engineer",
    overview: "Pulse pairs a browser-based financial terminal with a Flask machine-learning API. It retrieves historical stock and crypto data, engineers price and indicator features, combines linear regression with random forest forecasts, and presents up to five business days of projected market movement.",
    features: [
      "Five-day recursive forecasting with a blended linear-regression and random-forest model",
      "Technical-analysis overlays for SMA, EMA, RSI, MACD, volume, and uncertainty bands",
      "Ticker search, multi-currency display, consensus signals, and CSV export for prediction data",
    ],
  },
];
