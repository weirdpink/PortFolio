  ...
  return (
    <section id="about" className="bg-white dark:bg-neutral-950">
      <div className="mx-auto w-full px-6 py-24 md:px-12 md:py-32">
        ...
        <div className="flex flex-col gap-12 border-b border-black/10 pb-12 dark:border-white/10 md:flex-row md:items-start md:justify-between md:pb-16">
          <Reveal className="max-w-xs">
            <SectionMarker index="01" label="About" />
            <p className="mt-6 text-[14px] leading-relaxed text-neutral-500">
              Operating at the intersection of technical engineering and visual
              design, bridging the gap between logic and emotion.
            </p>
          </Reveal>
        ...
        <div className="mt-8 grid gap-12 md:mt-10 md:grid-cols-12 md:gap-14">
          <Reveal className="max-w-xl md:col-span-7">
            <div className="space-y-5 text-[16px] leading-relaxed text-neutral-700 dark:text-neutral-300">
              <p>
          ...
          <div className="md:col-span-4 md:col-start-9">
            <StaggerGroup
              as="div"
              className="divide-y divide-black/10 border-y border-black/10 dark:divide-white/10 dark:border-white/10"
            >
              {facts.map((f) => (
                <motion.div key={f.k} variants={itemVariants} className="py-5">
                  <div className="eyebrow mb-2">{f.k}</div>
                  <div className="text-[15px] leading-snug text-neutral-800 dark:text-neutral-200">
                    {f.v}
                  </div>
                </motion.div>
              ))}
